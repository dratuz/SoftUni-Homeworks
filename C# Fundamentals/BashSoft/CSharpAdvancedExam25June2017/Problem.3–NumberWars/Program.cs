...
namespace Problem._3_NumberWars
{
    class Program
    {
        ...
        {
            string p1Chars = string.Join(string.Empty,
                p1DrawCards.Select(x => x.Name)).ToLower();

            string p2Chars = string.Join(string.Empty,
                p2DrawCards.Select(x => x.Name)).ToLower();
